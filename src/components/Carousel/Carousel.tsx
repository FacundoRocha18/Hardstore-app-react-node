                ...
                {index === current && (
                  <Link to={`api/products/product/${item.id}`}>
                    <AdvancedImage
                      cldImg={cld
                        .image(
                          `${image_path}${item.banner || "banner_placeholder"}`,
                        )
                        .resize(fill().width(image_width).height(image_height))}
                    />
                  </Link>
                )}
              </li>
        ...
        <div className={style.carousel_indicator}>
          {slider_data.map((item, index) => (
            <button
              ...
              className={
                index === current
                  ? css(style.indicator, style.active)
                  : style.indicator
              }
              key={index}
            ></button>
